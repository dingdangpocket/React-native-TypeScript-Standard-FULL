...
export const PreInspectionComfirmScreen = wrapNavigatorScreen(
  () => {
    ...
    const onCancelPreInspection = () => {
      navigation.goBack();
    };
    const onStartPreInspection = () => {
      navigation.push('PreInspection', {});
    };
    return (
      <View
        css={`
      ...
      >
        ...
        <BottomButton
          leftText={'取消检测'}
          rightText={'开始检测'}
          onLeftPress={onCancelPreInspection}
          onRightPress={onStartPreInspection}
        />
      </View>
    );
  },
